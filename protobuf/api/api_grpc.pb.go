...
type APIClient interface {
	...
	SubscribeNewBlocks(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (API_SubscribeNewBlocksClient, error)
}
...
func (c *aPIClient) SubscribeNewBlocks(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (API_SubscribeNewBlocksClient, error) {
	stream, err := c.cc.NewStream(ctx, &API_ServiceDesc.Streams[5], "/api.API/SubscribeNewBlocks", opts...)
	if err != nil {
		return nil, err
	}
...
type APIServer interface {
	...
	// Opens a new block stream.
	SubscribeNewBlocks(*emptypb.Empty, API_SubscribeNewBlocksServer) error
...
func (UnimplementedAPIServer) SubscribeNewBlocks(*emptypb.Empty, API_SubscribeNewBlocksServer) error {
