...
func (c *aPIClient) SendTransaction(ctx context.Context, opts ...grpc.CallOption) (API_SendTransactionClient, error) {
	stream, err := c.cc.NewStream(ctx, &API_ServiceDesc.Streams[1], API_SendTransaction_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *aPIClient) SendRawTransaction(ctx context.Context, opts ...grpc.CallOption) (API_SendRawTransactionClient, error) {
	stream, err := c.cc.NewStream(ctx, &API_ServiceDesc.Streams[2], API_SendRawTransaction_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *aPIClient) SendTransactionSequence(ctx context.Context, opts ...grpc.CallOption) (API_SendTransactionSequenceClient, error) {
	stream, err := c.cc.NewStream(ctx, &API_ServiceDesc.Streams[3], API_SendTransactionSequence_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *aPIClient) SendRawTransactionSequence(ctx context.Context, opts ...grpc.CallOption) (API_SendRawTransactionSequenceClient, error) {
	stream, err := c.cc.NewStream(ctx, &API_ServiceDesc.Streams[4], API_SendRawTransactionSequence_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *aPIClient) SubscribeExecutionPayloads(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (API_SubscribeExecutionPayloadsClient, error) {
	stream, err := c.cc.NewStream(ctx, &API_ServiceDesc.Streams[5], API_SubscribeExecutionPayloads_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *aPIClient) SubscribeExecutionHeaders(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (API_SubscribeExecutionHeadersClient, error) {
	stream, err := c.cc.NewStream(ctx, &API_ServiceDesc.Streams[6], API_SubscribeExecutionHeaders_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *aPIClient) SubscribeBeaconBlocks(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (API_SubscribeBeaconBlocksClient, error) {
	stream, err := c.cc.NewStream(ctx, &API_ServiceDesc.Streams[7], API_SubscribeBeaconBlocks_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
